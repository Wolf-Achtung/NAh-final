...
export function systemPrompt(persona) {
  const base =
    'Gib klare, kurze Schritte. Maximal zehn Wörter. Sag zuerst, was wichtig ist. Keine Fachsprache.';
  switch (persona) {
    case 'child':
 ...
 * allows 7 words, standard 10, detail 14. The persona parameter is
 * ignored here, but could be used for additional constraints.
 */
export function limitText(text, level) {
  let maxWords = 10;
